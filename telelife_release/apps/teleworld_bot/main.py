...
def register(application:Application)->None:
 onboarding.register(application);country.register(application);production.register(application);politics.register(application);application.add_error_handler(make_error_handler(fa.ERROR))
