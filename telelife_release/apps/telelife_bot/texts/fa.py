...
BTN_ECONOMY = "💳 اقتصاد من"
BTN_JOBS = "💼 شغل من"
BTN_MARKET = "💵 بازار دلار"
BTN_SAVINGS = "🏦 پس‌انداز"
BTN_HOUSING = "🏠 خانه و زندگی"
BTN_DEPOSIT = "واریز به پس‌انداز"
BTN_WITHDRAW = "برداشت از پس‌انداز"
BTN_COLLECT_JOB = "📦 دریافت دستمزد"
BTN_UPGRADE_PRODUCTION = "⚙️ ارتقای تولید"
BTN_UPGRADE_STORAGE = "🗄 ارتقای انبار"
ECONOMY_PANEL = """💳 <b>اقتصاد شخصی</b>

👛 کیف پول: <b>{wallet}</b>
🏦 پس‌انداز: <b>{savings}</b>
🏠 خانه: <b>{housing}</b>
🧾 هزینه زندگی معوق: <b>{living}</b>

هر جابه‌جایی پول اتمیک و در دفتر تراکنش ثبت می‌شود."""
JOBS_PANEL = """💼 <b>مسیر شغلی</b>

{body}

تولیدت سقف دارد؛ قبل از پرشدن انبار آن را دریافت کن."""
MARKET_PANEL = """💵 <b>بازار زنده دلار</b>

نرخ خرید: <b>{buy}</b>
نرخ فروش: <b>{sell}</b>
سلامت بازار: <b>{health}٪</b>
حجم امروز: <b>{volume}</b>
وضعیت: <b>{status}</b>

موجودی تو: <b>{usd}</b> دلار
نوسان هر معامله محدود و همه خریدوفروش‌ها حسابرسی می‌شوند."""
ACTION_DONE = "✅ عملیات با موفقیت انجام شد."
ERROR_FRIENDLY = "این عملیات انجام نشد: {reason}"
